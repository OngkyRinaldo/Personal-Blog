...
<section>
    ...
    <div class="container">
        ...
        <h1 class="text-center mt-3">{{ $tag->title }}</h1>
            ...
            <div class="col-lg-4 col-md-4 col-6 mt-4 col-card-index">
                ...
                <div class=" card card-index">
                    ...
                    <div class=" position-absolute p-3 py-2 card-category-title text-center">
                        ...
                        <a href="{{ route('guest.category', $post->category) }}">{{ $post->category->title }}</a>
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title text-center">
                            <a href="{{ route('guest.post', $post) }}" class="text-decoration-none text-dark">
