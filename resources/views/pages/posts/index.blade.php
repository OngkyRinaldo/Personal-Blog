...
<div class="container">
    ...
    <nav aria-label="breadcrumb" class="breadcrumb mt-3">
        ...
        <ol class="breadcrumb ">
            ...
            <li class="breadcrumb-item">{{ Str::limit($post->title, 20) }}</li>
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-8">
            ...
            <a href="{{ route('guest.category', $post->category) }}">
                ...
                <button type="button" class="btn btn-dark mb-3">{{$post->category->title }}</button>
            ...
            <div class="text-end">
                ...
                <h5> By :
                    <a href="{{ route('guest.author', $post->post_author) }}" class=" text-decoration-none
                        text-dark h5-author">{{$post->post_author->username }}
                    </a>
            ...
            <a href="{{ route('guest.index') }}">
                <button type="button" class="btn btn-dark">Back to all post</button>
            </a>
        </div>
